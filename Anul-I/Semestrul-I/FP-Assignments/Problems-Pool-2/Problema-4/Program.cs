...
namespace Problema_1
{
    class Program
    {
        private static long Numar, CopieNumar, Pozitie = -1, NumarAuxiliar = 0;
        /// <summary>
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                CopieNumar = Numar = long.Parse(Console.ReadLine());

                Console.Write("\n Introducetu numarul cautat: ");
                long NumarCautat = long.Parse(Console.ReadLine());
                ...
                while (Numar > 0)
                {
                    ...
                    {
                        if (NumarAuxiliar == NumarCautat && Gasit == false)
                        {
                            Gasit = true;

                            Pozitie = CopieNumar - Numar;
                        }
