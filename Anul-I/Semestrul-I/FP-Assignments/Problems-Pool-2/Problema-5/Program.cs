...
namespace Problema_1
{
    class Program
    {
        private static long Numar, CopieNumar, Suma = 0, NumarAuxiliar = 0;
        /// <summary>
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                while (Numar > 0)
                {
                    ...
                    {
                        if (NumarAuxiliar == CopieNumar - Numar)
                        {
                            Suma++;
                        }
        ...
        {
            Console.Write($"\n\n Numarul de numere egale cu pozitia pe care se afla este egal cu: {Suma} \n\n");
        }
    }
}
