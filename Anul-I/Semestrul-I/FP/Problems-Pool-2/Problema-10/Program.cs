...
namespace Problema_1
{
    class Program
    {
        private static long Numar, NumarAnterior = 0, Suma = 1, SumaMaxima = 1, NumarAuxiliar = 0;
        private static bool PrimulNumar = false;
        /// <summary>
        ...
        /// <summary>
        /// 'Suma' contorizeaza lungimea unei subsecvente de numere egale si
        /// este atribuit sumei maxime in caz ca este mai mare ca aceasta.
        /// </summary>
        ...
        {
            Console.Write($"\n\n Numarul maxim de numere consecutive egale din secventa este: {SumaMaxima}\n\n");
        }
    }
}