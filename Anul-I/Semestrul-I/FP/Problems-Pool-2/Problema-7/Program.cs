...
namespace Problema_1
{
    class Program
    {
        private static long Numar, Maxim = 0, Minim = 0, NumarAuxiliar = 0;
        /// <summary>
            ...
            try
            {
                ...
                while (Numar > 0)
                {
                    ...
                    if (NumarCompus(Cifra) == true)
                    {
                        if (PrimulNumar == true)
                        {
                            if (NumarAuxiliar < Minim)
                            {
                                Minim = NumarAuxiliar;
                            }
                            if (NumarAuxiliar > Maxim)
                            {
                                Maxim = NumarAuxiliar;
                            }
                        }
        ...
        {
            Console.Write($"\n\n Valoarea maxim din secventa este: {Maxim} , iar cea minima: {Minim}\n\n");
        }
    }
}
